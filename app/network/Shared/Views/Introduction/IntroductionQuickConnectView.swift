...
//  Home Screen widgets, with previews drawn from sample data so they look
//  like the real thing, and the steps to add them, since iOS and macOS have
//  no system request for adding a control or pinning a widget.
//
