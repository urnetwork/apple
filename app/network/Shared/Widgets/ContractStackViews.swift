//
//  ContractStackViews.swift
//  URnetwork
//
//  The contracts widget's peer cards, stacks and flowing layout. Compiled
//  into the app and the widget extension: the app's Account > Widgets
//  screen draws the widget preview with these very views.
//
